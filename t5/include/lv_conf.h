...
/* T5 e-paper: 8-bit grayscale (mapped to 4-bit/16 levels by flush callback) */
...
/* T5 e-paper: ~4 FPS max (partial refresh is ~0.3s) */
#define LV_DEF_REFR_PERIOD  250     /*[ms]*/

/*Default Dot Per Inch. Used to initialize default sizes such as widgets sized, style paddings.
 *(Not so important, you can adjust it to modify default sizes and spaces)*/
/* T5 e-paper: 960x540 on 4.7" → ~220 DPI */
...
/* T5 e-paper: Enable fonts used by the ventilation panel UI */
