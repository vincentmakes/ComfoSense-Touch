...
void GUI_initScreen__screen () {
    ...
    lv_obj_remove_flag( GUI_Screen__screen, LV_OBJ_FLAG_SCROLLABLE );
     ...
     lv_obj_set_size( GUI_Panel__screen__panel, 465, 66 );
      ...
      GUI_Image__screen__image = lv_image_create( GUI_Panel__screen__panel );
      ...
      GUI_Image__screen__wifi = lv_image_create( GUI_Panel__screen__panel );
     ...
     lv_obj_set_size( GUI_Panel__screen__panel_1, 462, 77 );
      ...
      lv_obj_set_size( GUI_Button__screen__BSpeedMinus, 150, 66 );
       ...
       GUI_Image__screen__minus = lv_image_create( GUI_Button__screen__BSpeedMinus );
      ...
      lv_obj_add_event_cb( GUI_Button__screen__BSpeedPlus, GUI_event__Button__screen__BSpeedPlus__Clicked, LV_EVENT_CLICKED, NULL );
       ...
       GUI_Image__screen__plus = lv_image_create( GUI_Button__screen__BSpeedPlus );
     ...
     GUI_Image__screen__fanspeed0 = lv_image_create( GUI_Screen__screen );
     ...
     GUI_Image__screen__fanspeed1 = lv_image_create( GUI_Screen__screen );
     ...
     GUI_Image__screen__fanspeed2 = lv_image_create( GUI_Screen__screen );
     ...
     GUI_Image__screen__fanspeed3 = lv_image_create( GUI_Screen__screen );
     ...
     GUI_Image__screen__fanspeedboost = lv_image_create( GUI_Screen__screen );
...
void GUI_initScreenStyles__screen () {
    lv_obj_add_style( GUI_Screen__screen, &GUI_Style__class_IjzeXjGNl2hqzr__, LV_PART_MAIN | LV_STATE_DEFAULT );
     ...
     lv_obj_add_style( GUI_Panel__screen__panel, &GUI_Style__class_YGYDXpOgt1PZ82__, LV_PART_MAIN | LV_STATE_DEFAULT );
      ...
      lv_image_set_src( GUI_Image__screen__image, &upload_warningoutline_2343dccdd2da484cab2db0b1a6f4ab6b_png );

      lv_obj_add_style( GUI_Image__screen__image, &GUI_Style__class_2QBFIVRjDIrU4g__, LV_PART_MAIN | LV_STATE_DEFAULT );

      lv_image_set_src( GUI_Image__screen__wifi, &upload_wifioutline_1922d60a08324fb58b6286008444cc13_png );
     ...
     lv_obj_add_style( GUI_Panel__screen__panel_1, &GUI_Style__class_1v6NR7CCKSOY1p__, LV_PART_MAIN | LV_STATE_DEFAULT );
      ...
      lv_obj_add_style( GUI_Button__screen__BSpeedMinus, &GUI_Style__class_ZQFNgZyvWmNGIo__, LV_PART_MAIN | LV_STATE_DEFAULT );
       ...
       lv_image_set_src( GUI_Image__screen__minus, &upload_minus_22b4150ed8454f4f8d0531614cfc727c_png );

      lv_obj_add_style( GUI_Button__screen__BSpeedPlus, &GUI_Style__class_qitjx2mC7B2BMR__, LV_PART_MAIN | LV_STATE_DEFAULT );

       lv_image_set_src( GUI_Image__screen__plus, &upload_plus_68d2c2cb30b349e2b7f71cb50dfbe8b8_png );
     ...
     lv_image_set_src( GUI_Image__screen__fanspeed0, &upload_fan0_4bd7cbea47ab4747a7ba1a8e654304d3_png );

     lv_image_set_src( GUI_Image__screen__fanspeed1, &upload_fan1_5f7d42737550431ebd8adb45b281d499_png );

     lv_image_set_src( GUI_Image__screen__fanspeed2, &upload_fan2_4980bc102f3943d19cdcd71981ffdd64_png );

     lv_image_set_src( GUI_Image__screen__fanspeed3, &upload_fan3_84f063b5abbd4a2eb99f1df624dad654_png );

     lv_image_set_src( GUI_Image__screen__fanspeedboost, &upload_fanboost_09b958c807d44065830a9fbfb5e59bb8_png );

     lv_obj_add_style( GUI_Dropdown__screen__modedropdown, &GUI_Style__class_i65QyXalE1u3QM__, LV_PART_MAIN | LV_STATE_DEFAULT );
     lv_obj_add_style( GUI_Dropdown__screen__modedropdown, &GUI_Style__class_5qfkyxJclqQGgq__, LV_PART_LIST_MAIN | LV_STATE_DEFAULT );
